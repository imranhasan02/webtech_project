  ...
  <script>tinymce.init({ selector:'textarea' });</script>
	...
	<body bgcolor ="skyblue">
		...
		<form action = "insert_product.php" method ="post" enctype "multipart/form-data">
			<table align = "centre" width="700" border "2" bgcolor="#FFFF00">
				<tr align="centre">
...
if (isset($_POST['insert_post'])) {
    ...
    echo $insert_product = "insert into products (product_cat,product_brand,product_title,product_price,product_desc,product_image,product_keywords) values 
